...
public class Boss extends Enemy {
    ...
    public static Boss bigBoss(){
        ...
        int speed = 15 ;
        double exp = 250 ;
        return new Boss("BigBoss", stamina, attack, defense, speed, 10000, exp, true);
    }
    ...
    public static Boss Joe(){
        ...
        int speed = 25 ;
        double exp = 250 ;
        return new Boss("Joe Yabuki", stamina, attack, defense, speed, 10000, exp, true);
    }
    ...
    public static Boss vas(){
        ...
        int speed = 25 ;
        double exp = 250 ;
        return new Boss("Vas", stamina, attack, defense, speed, 10000, exp, true);
    }
    ...
    public static Boss dutch(){
        ...
        int speed = 40 ;
        double exp = 250 ;
        return new Boss("Dutch Van Der Linde", stamina, attack, defense, speed, 10000, exp, true);
    }
